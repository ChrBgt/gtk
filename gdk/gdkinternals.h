...
/*eof CHB functions added */

GDK_AVAILABLE_IN_ALL void     gdk_event_set_pointer_emulated (GdkEvent *event,
                                         gboolean  emulated);

GDK_AVAILABLE_IN_ALL void     gdk_event_set_scancode        (GdkEvent *event,
                                        guint16 scancode);

GDK_AVAILABLE_IN_ALL void     gdk_event_set_seat              (GdkEvent *event,
                                          GdkSeat  *seat);
...
GDK_AVAILABLE_IN_ALL GdkDrawingContext *gdk_window_get_drawing_context (GdkWindow *window);

GDK_AVAILABLE_IN_ALL cairo_region_t *gdk_window_get_current_paint_region (GdkWindow *window);
...
GDK_AVAILABLE_IN_ALL PangoDirection gdk_unichar_direction (gunichar ch);
/*CHB end addings*/
